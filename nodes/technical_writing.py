...
def escrever_secoes_node(state: EscritaTecnicaState) -> dict:
    ...
    for pos, secao in enumerate(secoes):
        ...
        for i, url in enumerate(urls_usadas_fase6, 1):
            fonte_map_secao[url.id] = url.url
        ...
        texto_final, relatorio_verif, stats = _verificar_e_corrigir_secao_com_ancora(
            rascunho, 
            corpus, 
            fonte_map_secao,  # ← IMPORTANTE: passar o fonte_map
            titulo, 
            cont_esp
        )
...
# ============================================================================
# FUNÇÕES AUXILIARES PARA ÂNCORAS (copie para technical_writing.py)
# ============================================================================
...
# ============================================================================
# VERIFICAÇÃO MELHORADA COM BUSCA POR ÂNCORA + URL
# ============================================================================
    ...
    # === ESTRATÉGIA 2: Busca por múltiplas âncoras (se houver) ===
        ...
        if ancoras_com_cit:
            ...
            if ancoras_com_urls:
                ...
                # Nenhuma URL válida → busca geral
                fontes = corpus.render_prompt(bloco_limpo[:300], max_chars=3000)[0]
        else:
...
# ============================================================================
# INTEGRAÇÃO NO LOOP DE VERIFICAÇÃO
# ============================================================================
...
def _verificar_e_corrigir_secao_com_ancora(
    ...
    SUBSTITUI: _verificar_e_corrigir_secao_adaptativa
    """
    urls_tentadas = set()
    iteracao = 0
    ...
    while iteracao < 3:
        ...
        # Busca complementar se necessário
        num_novos, corpus, msg = _buscar_conteudo_complementar(
            titulo, conteudo_esperado, corpus, urls_tentadas
        )
        log_linhas.append(f"\n**Busca:** {msg}")
