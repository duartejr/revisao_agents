...
# ============================================================================
# INTEGRAÇÃO NO escrever_secoes_node
# ============================================================================

"""
MUDANÇA 1: NO escrever_secoes_node, APÓS a FASE 6 (rascunho):
    ...
    # Guardar para consolidar_node
    secoes_escritas.append({
        ...
        "fonte_map": fonte_map_secao,  # ← ADICIONE
        ...
    })
"""
...
# ============================================================================
# INTEGRAÇÃO NO consolidar_node
# ============================================================================

"""
MUDANÇA 2: NO consolidar_node, ANTES de montar referências:
    ...
    # Sincroniza texto com referencias
    documento_temp = "\n".join(partes)
    documento, all_urls_sincronizadas = sincronizar_texto_com_references(
        documento_temp,
        fonte_map_consolidado
    )
    all_urls = all_urls_sincronizadas
    print(f"     ✅ {len(all_urls)} referências sincronizadas")
