...
def build_technical_workflow(
    ...
    0. Theme Refinement: Detect language and evaluate theme vagueness before any search.
    ...
    builder.add_conditional_edges(
        "identify_and_refine",
        refinement_router,
        {"proceed": "initial_technical_search", "clarify": "human_pause"},
    )
    ...
    builder.add_conditional_edges(
        ...
        post_pause_router,
        {
            ...
            "proceed": "initial_technical_search",
            "interview": "refine_technical_search",
        },
    )
