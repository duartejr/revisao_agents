"""
Anchor helpers - Utilities for working with anchor-based citations in technical writing.

Provides functions for:
- Extracting anchors and citations
- Managing anchor patterns
- Cleaning anchors from text
"""
